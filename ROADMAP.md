...
| 1 | Базовая оркестрация | - | 🔲 |
| 2 | RAG-агенты | - | 🔲 |
| 3 | Итеративный процесс | - | 🔲 |
| 4 | Формализация и вывод | - | 🔲 |
| 5 | Эволюция и оптимизация | - | 🔲 |
...
- [ ] Настроить pgvector
- [ ] Настроить Redis
- [ ] Добавить credentials в n8n

### Фаза 1
- [ ] Создать workflow `Cosilium-Orchestrator`
- [ ] Создать sub-workflow `Agent-ChatGPT`
- [ ] Создать sub-workflow `Agent-Claude`
- [ ] Создать sub-workflow `Agent-Gemini`
- [ ] Создать sub-workflow `Agent-DeepSeek`
- [ ] Протестировать параллельный вызов

### Фаза 2
- [ ] Заполнить начальные промты в `rag_prompts`
- [ ] Заполнить образы мышления в `rag_thinking_patterns`
- [ ] Создать workflow загрузки контекста
- [ ] Настроить семантический поиск

### Фаза 3
- [ ] Реализовать Iteration 1 (независимый анализ)
- [ ] Реализовать Iteration 2 (adversarial critique)
- [ ] Реализовать Iteration 3 (synthesis)
- [ ] Протестировать полный цикл

### Фаза 4
- [ ] Реализовать форматирование отчёта
- [ ] Реализовать таблицу выводов
- [ ] Реализовать рендеринг формул
- [ ] Реализовать сравнение рекомендаций

### Фаза 5
- [ ] Настроить сбор метрик
- [ ] Реализовать эволюцию промтов
...
**Для минимально работающей версии:**

1. ✅ Документация (ARCHITECTURE.md, ROADMAP.md)
2. 🔲 Таблицы Supabase (Фаза 0.1)
3. 🔲 Базовый оркестратор с 1 итерацией (Фаза 1.1)
4. 🔲 Агенты ChatGPT и Claude (Фаза 1.2-1.3)
5. 🔲 Простой вывод результата (Фаза 4.2)

**После MVP:**
- Добавить Gemini и DeepSeek
- Реализовать 3 итерации
- RAG-агенты
- Эволюция промтов
